...
class Logger(object):
    ...
    def write(self,string):
        ...
        try:
            ...
            string = ''.join([c if ord(c) < 128 else '?' for c in string ])
            sys.__stdout__.write(string)
        except UnicodeDecodeError as e:
            sys.__stderr__.write(self.getTrace()+"UnicodeDecodeError\n")
        except AttributeError as e:
            sys.__stderr__.write(self.getTrace()+"AttributeError\n")
        except Exception as e:
            sys.__stderr__.write(self.getTrace()+"Exception\n")
